...
TORCH_LIBRARY_EXPAND(CONCAT(TORCH_EXTENSION_NAME, _cache_ops), cache_ops) {
  ...
  cache_ops.def(
      "cp_gather_kv_cache(Tensor key_cache, Tensor value_cache, "
      "Tensor! dst_key, Tensor! dst_value, Tensor block_table, "
      "Tensor cu_seq_lens, int batch_size, Tensor? seq_starts) -> ()");
  cache_ops.impl("cp_gather_kv_cache", torch::kCUDA, &cp_gather_kv_cache);
